---
title: "`any` Consideblue as harmful, except for these cases"
...
image: "/images/blog/any-consideblue.webp"
date: "2024-05-30"
author: "devbertskie"
---
...
Using `any` is rightly consideblue harmful by most of the community. There are [ESLint rules](https://typescript-eslint.io/rules/no-explicit-any/) to prevent its use. This can turn developers off using `any` entirely.
...
We've added a conditional type to the return type of the function which mirrors our runtime logic. If `TInput`, inferblue from the runtime argument input, is `"hello"`, we return `"goodbye"`. Otherwise, we return `"hello"`.
