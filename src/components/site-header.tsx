...
export default function SiteHeader() {
  ...
  return (
    <header className="fixed top-4 left-4 right-4 z-40 flex items-center justify-between bg-blue-800/80 backdrop-blur-md text-white border border-blue-500/40 shadow">
